...
struct SiteSettingsView: View {
    ...
    @State private var successSelector: String = ""
    ...
    var body: some View {
        Form {
            ...
            Section {
                ...
                TextField("Success CSS selector (optional)", text: $successSelector)
                    .font(.callout.monospaced())
                    .autocorrectionDisabled()
                    .textInputAutocapitalization(.never)
            } header: {
    ...
    private func loadSettings() {
        ...
        if let existing = try? modelContext.fetch(descriptor).first {
            ...
            successSelector = existing.successSelector
        }
    ...
    private func save() {
        ...
        target.successSelector = successSelector
